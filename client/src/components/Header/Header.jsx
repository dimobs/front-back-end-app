                ...
                ? (
                   <>
                    <div className='hasUser'>
                                    ...
                                    {totalAmount >= 0 
                                    ? (<div style={{padding: "5px",background:"rgba(0, 255, 0, 0.05)", opacity: "0.8", borderRadius: '19px', border: "1px solid #2a9d8f"}} className='balance'>
                                        ...
                                        : 
                                        (<div style={{padding: "5px",background:"rgba(255, 0, 0, 0.15)", opacity: "0.8", borderRadius: '19px', border: "1px solid #2a9d8f"}} className='balance'>
                                            <div className='balance__bgn'>
                                            <span className='balance__label'>BGN</span>
                                            <span>{totalAmount == "0.00" ? "0.00" : totalAmount}</span>
                                            </div>
